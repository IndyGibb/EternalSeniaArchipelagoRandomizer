...
class GenericWeb(WebWorld):
    ...
    mac = Tutorial(
        "Archipelago Setup Guide for Mac",
        "A guide detailing how to run Archipelago clients on macOS.",
        "English",
        "mac_en.md",
        "mac/en",
        ["Bicoloursnake", "silasary"],
    )
    plando = Tutorial(
        "Archipelago Plando Guide",
        "A guide to understanding and using plando for your game.",
        "English",
        "plando_en.md",
        "plando/en",
        ["alwaysintreble", "Alchav"],
    ...
    setup = Tutorial(
        "Getting Started",
        "A guide to setting up the Archipelago software, and generating, hosting, and connecting to multiworld games.",
        "English",
        "setup_en.md",
        "setup/en",
        ["alwaysintreble"],
    ...
    triggers = Tutorial(
        ...
        "A guide to setting up and using triggers in your game settings.",
        "English",
        "triggers_en.md",
        "triggers/en",
        ["alwaysintreble"],
    )
    other_games = Tutorial(
